...
import type { PortfolioCaseStudy, ProfileDocument } from "@/lib/types";
import { PortfolioImageEditor } from "./PortfolioImageEditor";

type PortfolioCaseStudiesEditorProps = {
...
export function PortfolioCaseStudiesEditor({
  document,
  updateDocument,
  onStatus
}: PortfolioCaseStudiesEditorProps) {
